...
for j in range(3, 16):
    ...
    text += 'protocol.chord overlay.chord.ChordProtocol \n'
    text += '{\n'
    text += '   transport tr\n'
    text += '}\n\n'

    text += 'control.controlChord overlay.controls.ControlChord\n'
    text += '{\n'
    text += '   protocol chord\n'
    text += '   step '+stepControlChord+'\n'
    text += '}\n\n'
    ...
    text += 'init.create overlay.chord.ChordCreate\n'
    text += '{\n'
    text += '   protocol chord\n'
    text += '   idLength 256\n'
    text += '   scenario '+str(i)+'\n'
    ...
    text += '   stepChord '+str(stepControlChord)+'\n'
